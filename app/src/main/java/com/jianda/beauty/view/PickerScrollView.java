...
import com.jianda.beauty.bean.Pickers;
...
/**
 * Created by zhangqun on 2018/2/24.
 * 滚动选择器
 */
...
public class PickerScrollView extends View {
    ...
    public void setSelected(String mSelectItem) {
        for (int i = 0; i < mDataList.size(); i++) {
            Pickers pickers = mDataList.get(i);
            String showConetnt = pickers.getShowConetnt();
            if (showConetnt.equals(mSelectItem)) {
                setSelected(i);
                break;
            }else {
                setSelected(0);
